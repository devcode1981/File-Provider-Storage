...
ifeq ($(shallow_clone), true)
	git clone --depth=${clone_depth} ${gitlab_repo} gitlab
else
...
ifeq ($(shallow_clone), true)
	git clone --depth=${clone_depth} ${gitlab_shell_repo} ${gitlab_shell_clone_dir}
else
...
ifeq ($(shallow_clone), true)
	git clone --depth=${clone_depth} --quiet ${gitaly_repo} ${gitaly_clone_dir}
else
...
ifeq ($(shallow_clone), true)
	git clone --depth=${clone_depth} --quiet ${gitaly_proto_repo} ${gitaly_proto_clone_dir}
else
...
gitlab-docs/.git:
ifeq ($(shallow_clone), true)
	git clone --depth=${clone_depth} ${gitlab_docs_repo} gitlab-docs
else
...
ifeq ($(shallow_clone), true)
	git clone --depth=${clone_depth} ${gitlab_workhorse_repo} ${gitlab_workhorse_clone_dir}
else
...
ifeq ($(shallow_clone), true)
	git clone --depth=${clone_depth} ${gitlab_pages_repo} ${gitlab_pages_clone_dir}
else

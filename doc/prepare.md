...
| Git            | <p>We recommend using Git version 2.22 or higher.</p><p>git installation is covered in the instructions in the [Platform-specific setup](#platform-specific-setup).</p>                                                                                                                                                                                                                                                           |
...
1. Install remaining dependencies; modify the `GDK_GO_VERSION` with the major.minor version number as needed:
   ```
